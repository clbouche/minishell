...
cflags.debug		:= -Wall -Werror -Wextra -DDEBUG -ggdb -g3 -fsanitize=address #-fno-omit-frame-pointer
CFLAGS				:= $(cflags.$(BUILD))
...
lib.debug			:= $(lib.release) -g3 -fsanitize=address #-fno-omit-frame-pointer
LIB					:= $(lib.$(BUILD))
